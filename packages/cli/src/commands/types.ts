...
import type { PolicySet, RolePermission } from '@hexmon_tech/acccess-control-policy-dsl';
...
export function generatePolicyTypes(policy: PolicySet, rawPolicy?: unknown): string {
  ...
  lines.push('// Generated by @hexmon_tech/acccess-control-cli types. Do not edit manually.');
  lines.push('');
